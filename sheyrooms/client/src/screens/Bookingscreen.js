            ...
            {loading ? (<Loader/>) : error ? (<Error/>) : (
                ...
                <div className="row p-3 mb-5 bs" data-aos='flip-right' duration='2000'>
                      ...
                      <div className="col-md-6 text-right">
                           ...
                           <h1 className="amtbtn"><b>Total Amount : {totalAmount} /-</b></h1>

                           <StripeCheckout
            amount={totalAmount*100}
            shippingAddress
            token={tokenHander}
            stripeKey='pk_test_51PT6iIFzze6j3lSjDiyz6DO7lipbXLrmmdKGoUQpbEgHPWhU09bf4pynt4sFesA05BF5dglBOIIaqSeTainLI6QZ00tudB7t3O'
            currency='INR'
            >
